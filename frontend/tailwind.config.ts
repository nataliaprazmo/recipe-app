		...
		extend: {
			...
			boxShadow: {
				e1: `0px 2px 6px 2px rgba(33, 63, 8, 0.15),
					0px 1px 2px 0px rgba(33, 63, 8, 0.3),
					inset 0px 2px 1px 0px rgba(255, 255, 255, 0.75)`,
				e2: `0px 4px 8px 3px rgba(33, 63, 8, 0.15),
					0px 1px 3px 0px rgba(33, 63, 8, 0.3),
					inset 0px 2px 1px 0px rgba(255, 255, 255, 0.75)`,
				s1: `0px 2px 6px 1px rgba(33, 63, 8, 0.15),
					0px 1px 2px 0px rgba(33, 63, 8, 0.3)`,
				s2: `0px 4px 8px 1px rgba(33, 63, 8, 0.3),
					0px 2px 6px 0px rgba(33, 63, 8, 0.15)`,
				is1: `inset 2px 2px 2px 0px rgba(33, 63, 8, 0.3)`,
